...
public class Activity implements Serializable {
	...
	private ActivityCode activityCodeBean;
	...
	public Activity(Date endDate, String otherDetails, Date startDate, Project project) {
		super();
	...
	public ActivityCode getActivityCodeBean() {
		return this.activityCodeBean;
	}

	public void setActivityCodeBean(ActivityCode activityCodeBean) {
